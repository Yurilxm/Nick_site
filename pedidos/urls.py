...
from .views import (parcelas_cartao, pedido_confirmado, pagamento, meus_pedidos, verificar_pagamento, pedido_detalhe, salvar_endereco)
...
urlpatterns = [
    ...
    path("carrinho/salvar-endereco/", salvar_endereco, name="salvar_endereco"),
]